...
public class ASMBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ASMVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitLabelDeclaration(@NotNull ASMParser.LabelDeclarationContext ctx) { return visitChildren(ctx); }
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitValue(@NotNull ASMParser.ValueContext ctx) { return visitChildren(ctx); }
